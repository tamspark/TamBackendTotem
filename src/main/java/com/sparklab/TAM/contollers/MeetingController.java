...
public class MeetingController {
    ...
    @PostMapping("/generateTotemJitsiMeetLink")
    public ResponseEntity<?> generateTotemMeetingLink(@RequestBody TotemMeetingLinkDTO totemMeetingLinkDTO) throws Exception {
        return new ResponseEntity<>(meetingService.generateTotemMeetLink(totemMeetingLinkDTO), HttpStatus.OK);
