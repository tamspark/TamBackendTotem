...
public class ReservationFileService {
    ...
    public String writeApartmentsToFile(String userId) {
        ...
        List<ApartmentCalendarDTO> apartments = getReservations(userId,formattedDateLastYear, formattedDateAfterThreeMonths);
    ...
    private List<ApartmentCalendarDTO> getReservations(String userID,String fromDate, String toDate) {
//        return reservationService.getAllReservationsByDateCalendar("3", fromDate, toDate);
   //TODO check the userId should be dynamic fix it
        MultipartBodyBuilder builder = new MultipartBodyBuilder();
