...
public class OpenAIService {
    ...
    public ThreadDtoResponse createThread(String message, String type, Integer apartmentId,String userId) {
        //Refactored
      try {
          ...
          if (type.equals("host")) {
              requestBody = hostAssistantService.createHostThread(message,userId);
          }
