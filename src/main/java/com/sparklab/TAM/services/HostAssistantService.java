...
public class HostAssistantService {
    ...
    private static final String ASSISTANT_ID = "asst_VeXSkLucuj9tEjqRIU57W818";
    ...
    public Map<String, Object> createHostThread(String message,String userId) {
        ...
        String fileId = reservationFileService.writeApartmentsToFile(userId);
